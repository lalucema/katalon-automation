...
public class ConfirmationPage {
	...
	def waitHeader() {
		ui.waitForElement(confirmationPageObjects.headerConfirmation, "Confirmation Header")
	}

	def verifyConfirmationMessage(String expected = "Thank you for your purchase today!") {
		ui.assertText(confirmationPageObjects.headerConfirmation, expected, "Confirmation Header")
	}
