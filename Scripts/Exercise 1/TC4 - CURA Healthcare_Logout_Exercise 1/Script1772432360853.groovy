...
//Validate if Home Page Elements (Title, Subtitle, Button, Footer) are visible.
...
// Scroll and verify if "Copyright © CURA Healthcare Service 2026" is visible.
...
WebUI.click(findTestObject('Object Repository/Exercise 1/Page_CURA Healthcare Service/input_Username'))
...
// Click hamburger icon then click "Logout" button.

WebUI.click(findTestObject('Object Repository/Exercise 1/Page_CURA Healthcare Service/i_fa fa-bars'))

WebUI.click(findTestObject('Object Repository/Exercise 1/Page_CURA Healthcare Service/a_Logout'))
